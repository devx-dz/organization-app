...
mixin _$TaskState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Task> doneTasks, List<Task> tasks) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Task> doneTasks, List<Task> tasks)? loaded,
...
abstract class _$$_LoadedCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Task> doneTasks, List<Task> tasks});
}
...
class _$_Loaded implements _Loaded {
  const _$_Loaded(final List<Task> doneTasks, final List<Task> tasks)
  ...
  @override
  String toString() {
    return 'TaskState.loaded(doneTasks: $doneTasks, tasks: $tasks)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loaded?.call(doneTasks, tasks);
  }
...
abstract class _Loaded implements TaskState {
  const factory _Loaded(final List<Task> doneTasks, final List<Task> tasks) =
      _$_Loaded;
